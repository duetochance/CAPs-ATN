function [CP2,Disp,Std_Clusters,idx,d,sfrac] = Run_Clustering_UNIVR(XONn,n_clusters,n_rep,idx_sep_seeds,SeedType)
   ...
   % %For us since we use 100% we don't need this
