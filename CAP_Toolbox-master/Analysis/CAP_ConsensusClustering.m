...
function [Consensus_ordered] = CAP_ConsensusClustering(X,K_range,Subsample_type,Subsample_fraction,n_folds,DistType,maxiter)
    ...
    for k = 1:length(K_range)
        ...
        for h = 1:n_folds
            ...
            IDX = kmeans(X_ss,K_range(k),'Distance',DistType,'Replicates',1,'Start','uniform','maxiter',maxiter);
